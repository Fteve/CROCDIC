...
set numPadsShortEdge 14
set numPadsLongEdge 18
...
set westPitch [expr {floor($westSpan / double($numPadsShortEdge - 1))}]
...
set southPitch [expr {floor($southSpan / double($numPadsLongEdge - 1))}]
...
set eastPitch [expr {floor($eastSpan / double($numPadsShortEdge - 1))}]
...
set northPitch [expr {floor($northSpan / double($numPadsLongEdge - 1))}]
