...
int main() {
    ...
    *(volatile uint32_t *)CROCDIC_NR_OF_ELEMENTS = 1;
    ...
    *(volatile uint32_t *)CROCDIC_START = 0xDEADBEEF;
    ...
    // CHECK: check elements in destination array (ONLY THE 1st values should match the value in source array without modifications)
    for (int i = 0; i < 8; i++)
    {
